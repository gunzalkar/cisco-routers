...
def main():
    ...
    result = verify_key_chain_defined_87(connection)
    if result:
        print("Key chain with key-string 7 is defined.")
    else:
        print("Key chain with key-string 7 is not defined.")
    results.append({
        'Serial Number': 87,
        'Objective': 'Verify key chain with key-string 7 is defined.',
        'Result': 'Pass' if result else 'Fail',
        'Compliance': 'Compliant' if result else 'Non-Compliant'
    })
